...
class DerParser {
     ...
     *
     * <p/>
     * In BER/DER encoding, length can be encoded in 2 forms, <ul> <li>Short form. One octet. Bit 8 has value "0" and
     * bits 7-1 give the length. <li>Long form. Two to 127 octets (only 4 is supported here). Bit 8 of first octet has
     * value "1" and bits 7-1 give the number of additional length octets. Second and following octets give the length,
     * base 256, most significant digit first. </ul>
     *
...
class Asn1Object {
     ...
     * </pre>
     *
     * <ul> <li>Class: Universal, Application, Context or Private <li>CF: Constructed flag. If 1, the field is
     * constructed. <li>Type: This is actually called tag in ASN.1. It indicates data type (Integer, String) or a
     * construct (sequence, choice, set). </ul>
     *
